 ...
 * @author User
 */
public class Arcenal extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Arcenal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
